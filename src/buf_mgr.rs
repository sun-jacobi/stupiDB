...
mod test {
    ...
    fn buf_simple_test() {
        ...
        let blk_1 = Block::new(String::from("logtest.tbl"), 1);
        let blk_2 = Block::new(String::from("logtest.tbl"), 2);
        let blk_3 = Block::new(String::from("logtest.tbl"), 3);
        let blk_4 = Block::new(String::from("logtest.tbl"), 4);
        // init the table
        fm.write(&Block::new(String::from("logtest.tbl"), 0), &Page::new(100))
            .unwrap();
        ...
        let page1 = bm.pin(Block::new(String::from("logtest.tbl"), 1)).unwrap();
        for i in 0..100 {
            page1.set_byte(i, 1);
        }
        bm.unpin(Block::new(String::from("logtest.tbl"), 1))
            .unwrap();
        bm.pin(blk_2).unwrap();
        bm.pin(blk_3).unwrap();
        bm.pin(blk_4).unwrap();
        bm.unpin(Block::new(String::from("logtest.tbl"), 2))
            .unwrap();
